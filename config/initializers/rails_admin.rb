# RailsAdmin config file. Generated on July 09, 2013 16:50
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Poacc', 'Admin']
  ...
  config.included_models = ['Admin','Appointment', 'Practice','Followup','Assessment','Patient','Staff','PatientNumbers','Faq','FaqCategory','MarketingBullet','Testimonial']
