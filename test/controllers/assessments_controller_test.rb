...
class AssessmentsControllerTest < ActionController::TestCase
  ...
  test "should create assessment" do
    assert_difference('Assessment.count') do
      post :create, assessment: { Clinical: @assessment.Clinical, Complaints: @assessment.Complaints, Investigation: @assessment.Investigation }
    end
  ...
  test "should update assessment" do
    patch :update, id: @assessment, assessment: { Clinical: @assessment.Clinical, Complaints: @assessment.Complaints, Investigation: @assessment.Investigation }
    assert_redirected_to assessment_path(assigns(:assessment))
  end
