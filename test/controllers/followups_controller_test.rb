...
class FollowupsControllerTest < ActionController::TestCase
  ...
  test "should create followup" do
    assert_difference('Followup.count') do
      post :create, followup: { ClinicalPicture: @followup.ClinicalPicture, Date: @followup.Date, Plan: @followup.Plan }
    end
  ...
  test "should update followup" do
    patch :update, id: @followup, followup: { ClinicalPicture: @followup.ClinicalPicture, Date: @followup.Date, Plan: @followup.Plan }
    assert_redirected_to followup_path(assigns(:followup))
  end
